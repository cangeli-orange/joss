...
public class AccountImplTest extends BaseCommandTest {
    ...
    public void getPublicUROverride() {
        account = new AccountImpl(null, httpClient, defaultAccess, true, false, TempUrlHashPrefixSource.PUBLIC_URL_PATH, '/');
    ...
    public void isAllowCaching() throws IOException {
        account = new AccountImpl(null, httpClient, defaultAccess, false, false, TempUrlHashPrefixSource.PUBLIC_URL_PATH, '/'); // Caching is turned off
        prepareMetadata();
        account.getCount();
        account.getCount();
