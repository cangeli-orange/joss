...
public class StoredObjectImplTest extends BaseCommandTest {
    ...
    protected AbstractStoredObject createStoredObjectForTempURL(String password) {
        account = new AccountImpl(null, httpClient, AccessTest.setUpAccessWithURLwithPaths(), true, false, TempUrlHashPrefixSource.INTERNAL_URL_PATH, '/');
        List<Header> headers = new ArrayList<Header>();
    ...
    protected StoredObject createStoredObject(String name) {
        AccountImpl account = new AccountImpl(null, null, null, false, false, null, '/');
